...
export function Welcome({ message }: { message: string }) {
  return (
    <main className="mb-3 flex border-collapse items-center justify-center pb-4 pt-16">
          ...
          <nav className="space-y-4 rounded-3xl border border-gray-200 p-6 dark:border-gray-700">
            ...
            <ul>
              {resources.map(({ href, text, icon }) => (
                <li key={href}>
                  <a
                    className="group flex items-center gap-3 self-stretch p-3 py-12 leading-normal text-blue-700 hover:underline dark:text-blue-500"
                    href={href}
                    target="_blank"
                    rel="noreferrer"
                  >
